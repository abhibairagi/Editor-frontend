...
function Login() {
  ...
  const loginHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://editor-server-3y7k.onrender.com/user/login/",
        data,
        config
      );
  ...
  const signUpHandler = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://editor-server-3y7k.onrender.com/user/register/",
        data,
        config
      );
  ...
  const handleEmailChecker = async () => {
    await axios
      .post(
        `https://editor-server-3y7k.onrender.com/user/email-checker/${email}`,
        {},
        {
          headers: {
            "Content-type": "application/json",
